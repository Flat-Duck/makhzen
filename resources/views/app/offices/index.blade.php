@extends('layouts.app', ['page' => 'crud.offices.index_title'])

@section('title', trans('crud.offices.index_title') )
@section('content')
<div class="container-xl">
    <div class="page-header d-print-none">
        <h2 class="page-title">@lang('crud.offices.index_title')</h2>
    </div>
</div>
<div class="page-body">
    <div class="container-xl">
        <div class="card">
            ...
            <div class="table-responsive">
                ...
                >
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>@lang('crud.offices.inputs.name')</th>
                            <th>@lang('crud.offices.inputs.phone')</th>
                            <th>@lang('crud.offices.inputs.location')</th>
            ...
            @if( $offices->hasPages() )
            <div class="card-footer pb-0">{{ $offices->links() }}</div>
            @endif
        </div>
    </div>
</div>
